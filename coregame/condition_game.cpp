...
namespace Conditions
{
  ...
  // VarConst::Test
  //
  template <> Bool VarConst<U32>::Test(Team *team) 
  {
    ASSERT(team)
  ...
  // VarConst::Test
  //
  template <> Bool VarConst<F32>::Test(Team *team) 
  {
    ASSERT(team)
  ...
  // VarVar::Test
  //
  template <> Bool VarVar<U32>::Test(Team *team) 
  {
    ASSERT(team)
  ...
  // VarVar::Test
  //
  template <> Bool VarVar<F32>::Test(Team *team) 
  {
    ASSERT(team)
