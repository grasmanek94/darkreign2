...
void Team::CmdHandler(U32 pathCrc)
{
  ...
  switch (pathCrc)
  {
    ...
    case 0xD317A0F3: // "team.setrelation"
    {
      ...
      if (
        !Console::GetArgString(1, (const char *&)teamName) || 
        !Console::GetArgString(2, (const char *&)teamWithName) ||
        !Console::GetArgString(3, (const char *&)relation))
      {
    ...
    {
      char *name;
      if (!Console::GetArgString(1, (const char *&)name))
      {
    ...
    case 0x378674C4: // "team.objectives.new"
    {
      char *name;
      char *obj;
      if (!Console::GetArgString(1, (const char *&)name) || !Console::GetArgString(2, (const char *&)obj))
      {
    ...
    case 0x4A63A99D: // "team.listunits"
    {
      ...
      else
      {
        ...
        if (Console::GetArgString(2, (const char *&)type))
        {
