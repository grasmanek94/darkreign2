...
namespace MultiPlayer
{
  ...
  namespace Controls
  {
    ...
    void TransferList::Item::DrawSelf(PaintInfo &pi)
    {
      ...
      if (player)
      {
        Utils::Sprintf(buff, 128, (CH*)L"%s %s", offer->from ? L"From" : L"To", Utils::Ansi2Unicode(player->GetName()));
        ch = buff;
        pi.font->Draw
        (
      ...
      if (transferred < 1000)
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fB", F32(transferred));
      }
      else if (transferred < 1000000)
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fkB", F32(transferred) / 1000.0f);
      }
      else
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fMB", F32(transferred) / 1000000.0f);
      }
      ch = buff;
      pi.font->Draw
      (
      ...
      if (rate < 1000)
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fB/s", F32(rate));
      }
      else if (rate < 1000000)
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fkB/s", F32(rate) / 1000.0f);
      }
      else
      {
        Utils::Sprintf(buff, 128, (CH*)L"%.1fMB/s", F32(rate) / 1000000.0f);
      }
      pi.font->Draw
      (
      ...
      if (rate)
      {
        ...
        Utils::Sprintf(buff, 128, (CH*)L"%d:%02d", eta / 60, eta % 60);
      }
      else
      {
        ch = (CH*)L"?:??";
