...
namespace Strategic
{
    ...
    acceptInsufficient(acceptInsufficient)
  {
	...
	U32 ac = 0;
    for (; ac < ArmourClass::NumClasses(); ac++)
    {
      threat[ac] *= areaInv;
    }
    threatTotal *= areaInv;
    ...
    while ((sScope = scope->NextFunction()) != NULL)
    {
      switch (sScope->NameCrc())
      {
        ...
        case 0x98D9AF2E: // "Threat"
          StdLoad::TypeArray(sScope, threat, ArmourClass::NumClasses()); 
          break;
        ...
        case 0x07B0615D: // "Defense"
          StdLoad::TypeArray(sScope, defense, ArmourClass::NumClasses()); 
          break;
        ...
        case 0x8B11D7F9: // "AllocThreat"
          StdLoad::TypeArray(sScope, allocThreat, ArmourClass::NumClasses()); 
          break;

        case 0x8E9A4BF4: // "AllocDefense"
          StdLoad::TypeArray(sScope, allocDefense, ArmourClass::NumClasses()); 
          break;
